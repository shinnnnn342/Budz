    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Welcome to Budz laundry booking site!</h5>
            ...
            <br>
            <br>
            -No show policy: After 10 mins of your reserved time slot, your slot may be given to walk-ins or other client.
            <br>
            -Wear your face mask at all times and observe proper COVID-19 etiquette.
            <br>
            <br>
            Thank you!
            </div>
